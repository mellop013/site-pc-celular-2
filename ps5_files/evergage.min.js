...
Evergage.init({
    ...
    const sitemapConfig = {
        global: {
            ...
            onActionEvent: (actionEvent) => {
                ...
                // EDIT 6/19 - commenting out because it's causing merging issues
                // if (_gpdc_anonId) {
                ...
                if (_gpdc.user.isLoggedIn === true) {
                    ...
                    if (_gpdc.user.age != null) {
                        actionEvent.user.attributes.age = _gpdc.user.age
                    }

                    if (_gpdc.config.formattedLocale != null) {
                        actionEvent.user.attributes.locale = _gpdc.config.formattedLocale
                    }
        ...
        pageTypes: [
            {
                ...
                listeners: [
                    Evergage.listener('click', '[data-dtm-label="Discover PlayStation Plus"]', (event) => {
                        // console.log(event)
                        Evergage.sendEvent({
                            action: 'Discover Playstation Plus',
                        });
                    }),
                ],
            },
            {
                ...
                catalog: {
                    Product: {
                        _id: () => isValidEntry(getProductInformation()['productInfo'].conceptId) ? getProductInformation()['productInfo'].conceptId : '',
                        ...
                        imageUrl: () => {
                            if (getProductInformation()['locale'] === 'en-us') {
                                return getProductInformation()['productInfo'].image
                            } else { return '' }
                        },
    ...
    const getProductInformation = () => {
        let productInformation = SalesforceInteractions.cashDom('.basepage.page.basicpage').data();
        return {
            ...productInformation,
        };
    };
